...
<div class="form">
	...
	<?php 
	// category 1 for recordboon
	echo $form->hiddenField($model,'category_id',array('value'=>'2')); 
	?>
	...
	<div class="row">
        ...
        <?php echo $form->textField($model,'location',array('rows'=>6, 'cols'=>50)); ?>
